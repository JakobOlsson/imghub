...
run:
	AWS_ACCESS_KEY_ID=$(AWS_ACCESS_KEY_ID) AWS_SECRET_ACCESS_KEY=$(AWS_SECRET_ACCESS_KEY) DOCKER_IMG_URL=$(DOCKER_IMG_URL) DEBUG=$(DEBUG) docker-compose up --build

run-nobuild:
	AWS_ACCESS_KEY_ID=$(AWS_ACCESS_KEY_ID) AWS_SECRET_ACCESS_KEY=$(AWS_SECRET_ACCESS_KEY) DOCKER_IMG_URL=$(DOCKER_IMG_URL) DEBUG=$(DEBUG) docker-compose up --no-build
